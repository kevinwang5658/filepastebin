...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../../shared/constants", "./message"], factory);
    }
    ...
    var SocketFileSender = /** @class */ (function () {
        function SocketFileSender(file, socket, senderId) {
            var _this = this;
            this.file = file;
            this.socket = socket;
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                _a.label = 1;
                            case 1:
                                if (!(this.currentChunk * BYTES_PER_CHUNK < this.file.size)) return [3 /*break*/, 3];
                            ...
                            case 2:
                                _a.sent();
                                this.socket.send(new message_1.Message(this.senderId, message_1.MessageType.Data, null, this.fileReader.result));
                                this.currentChunk++;
                                this.onprogresschanged(this.currentChunk * BYTES_PER_CHUNK);
                                return [3 /*break*/, 1];
                            case 3:
                                this.socket.send(new message_1.Message(this.senderId, message_1.MessageType.Data, null, EOF));
                                return [2 /*return*/];
                        }
                    });
                });
        ...
        return SocketFileSender;
    }());
    exports.SocketFileSender = SocketFileSender;
});
//# sourceMappingURL=socketfilesender.js.map